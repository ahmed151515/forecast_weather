...
# hourly = Hourly(point, start, end)
# daily = daily.fetch()
# hourly = hourly.fetch()


# daily.to_csv(f'Frankfurt_Airport _daily_{start.year}_{end.year}.csv')
# hourly.to_csv(f"Frankfurt_Airport _hourly_{start.year}_{end.year}.csv")
...
daily_dataframe.to_csv("openmeteo_cairo_1940_2025.csv")